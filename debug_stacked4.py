...
from core.data_structures import OrderBook, PriceLevel, Trade, Side, SignalType, Regime, Signal
from knowledge.strategy_library import get_strategy, StrategyDefinition
...
print(f'Checked {idx-500+1} ticks')
